...
//A
{
    ...
    genreWeightings: [0.8, 0.6, 1, 0.8, 0.6, 0.7],
...
{ 
	...
	genreWeightings: [0.8, 0.9, 0.7, 0.8, 0.7, 0.4],
	audienceWeightings: [0.7, 0.9, 0.8 ]
},

{ 
	id: "animalsTopic.MGDT",
	name: "Animals".localize("game topic"),
	genreWeightings: [0.7, 0.8, 0.8, 0.9, 0.6, 0.7],
	audienceWeightings: [1, 0.8, 0.7]
},

//B
{ 
	id: "battleRoyaleTopic.MGDT",
	name: "Battle Royale".localize("game topic"),
	genreWeightings: [1, 0.6, 0.8, 0.7, 0.9, 0.6],
...
{ 
	...
	genreWeightings: [1, 0.8, 0.7, 0.6, 0.9, 0.6],
...
{ 
	...
	genreWeightings: [1, 0.8, 0.9, 0.6, 0.9, 0.6],
	audienceWeightings: [0.6, 1, 0.9 ]
},

{ 
	id: "cookingTopic.MGDT",
	name: "Cooking".localize("game topic"),
	genreWeightings: [0.6, 0.6, 0.7, 0.8, 0.8, 0.7],
...
{ 
	...
	genreWeightings: [0.8, 0.6, 0.7, 0.8, 1, 0.9],
	audienceWeightings: [0.7, 1, 0.8 ]
},

{ 
	id: "copsTopic.MGDT",
	name: "Cops".localize("game topic"),
	genreWeightings: [1, 0.8, 0.9, 0.8, 0.9, 0.6],
	audienceWeightings: [  0.9, 1, 0.7 ]
},

{ 
	id: "cityBuilderTopic.MGDT",
	name: "City Builder".localize("game topic"),
	genreWeightings: [1, 0.8, 0.6, 0.8, 0.9, 0.7],
	audienceWeightings: [0.9, 1, 0.7 ]
},
...
//D
{
	...
	genreWeightings: [1, 0.9, 0.7, 0.9, 0.8, 0.6],
	audienceWeightings: [0.7, 0.9, 0.7]
},
...
{ 
	id: "dressUpTopic.MGDT",
	name: "Dress Up".localize("game topic"),
	genreWeightings: [  1, 0.8, 0.9, 0.7, 0.9, 0.6 ],
	audienceWeightings: [  0.9, 1, 0.7 ]
},
...
{ 
	id: "eroticTopic.MGDT",
	name: "Erotic".localize("game topic"),
	genreWeightings: [0.8, 0.9, 0.8, 0.7, 0.6, 0.7],
...
//F
{
    ...
    genreWeightings: [0.8, 0.8, 0.6, 1, 0.7, 0.9],
    audienceWeightings: [0.8, 1, 0.6]
},

{ 
	id: "fightingTopic.MGDT",
...
{ 
	id: "firefightersTopic.MGDT",
	name: "Firefighters".localize("game topic"),
...
//G
{
    ...
    genreWeightings: [0.6, 0.6, 0.6, 0.7, 0.8, 1],
...

{
    ...
    genreWeightings: [0.8, 0.6, 0.6, 0.9, 0.9, 0.8],
    audienceWeightings: [0.7, 1, 1]
},

{ 
	id: "governmentTopic.MGDT",
	name: "Government".localize("game topic"),
	genreWeightings: [0.6, 0.7, 0.8, 0.8, 1, 0.6 ],
	audienceWeightings: [  0.6, 0.7, 0.9]
},

//H
{ 
	id: "hackNSlashTopic.MGDT",
	name: "Hack 'n' Slash".localize("game topic"),
	genreWeightings: [1, 0.9, 0.8, 0.7, 0.9, 0.6 ],
	audienceWeightings: [0.7, 0.8, 0.9]
},

{ 
	id: "hospitalTopic.MGDT",
	name: "Hospital".localize("game topic"),
	genreWeightings: [1, 0.7, 0.9, 0.8, 0.9, 0.6 ],
...
{ 
	id: "paramedicsTopic.MGDT",
	name: "Paramedics".localize("game topic"),
	genreWeightings: [1, 0.8, 0.9, 0.7, 0.9, 0.6 ],
	audienceWeightings: [  0.9, 1, 0.7 ]
},
...
{ 
	id: "surgeonTopic.MGDT",
	name: "Surgeon".localize("game topic"),
	genreWeightings: [  1, 0.8, 0.9, 0.7, 0.9, 0.6 ],
	audienceWeightings: [  0.9, 1, 0.7 ]
},

{ 
	id: "sandboxTopic.MGDT",
	name: "Sandbox".localize("game topic"),
	genreWeightings: [0.7, 0.8, 0.8, 0.7, 0.9, 0.6 ],
	audienceWeightings: [0.9, 1, 0.7 ]
},
