        ...
        getNotification: function (company) {
            return new Notification({
				header : "Industry News".localize(),
                    text : "Soon after the Telegent was discontinued, Tammel has announced that they are continuing to support this platform, however there is a catch. {n} The catch being that the name of the platform has been changed to 'Console 3'. Even though they haven't lost any marketshare we aren't sure if it will increase any further with the name change. Set to be released  {0}.".localize().format(General.getETADescription('1/9/3', '1/9/3')),
