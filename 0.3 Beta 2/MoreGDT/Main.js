...
var div = $("body");
  ...
  '<div id="discordButton" class="selectorButton centeredButtonWrapper" onclick="moreGDT.discordPage()" style="margin:0 auto">Discord Server (Closed)</div>' +
  '<div id="SGButton" class="selectorButton centeredButtonWrapper" onclick="moreGDT.SGPage()" style="margin:0 auto">Steam Group (Closed)</div>' +
