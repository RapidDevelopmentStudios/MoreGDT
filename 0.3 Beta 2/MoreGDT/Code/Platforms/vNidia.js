    ...
    events : [{
            ...
            getNotification : function (company) {
                return new Notification({
                    ...
                    text : "Today vNidia announced a new product, outside of their line of Graphics Cards, this new product is called the vNidia Armour. This product comes in two models, Armour and Armour Pro with $100 difference between them. The key features of this device include support for 4k HDR video, gaming in the cloud or from your PC and having much more powerful hardware than other streaming hardware currently available.".localize().format(General.getETADescription('22/11/2', '23/12/3')),
