        ...
        getNotification: function (company) {
            return new Notification({
				header : "Industry News".localize(),
                    text : "Atira, a home gaming console company, today announced the Atira 78. {n} This home gaming console is an improvement over the previous Atira PowerPlayer while still keeping compatibility with the games developed for it. {n} Although production of the system seems questionable there's no reason why it shouldn't do well. {0}.".localize().format(General.getETADescription('22/11/2', '23/12/3')),
