...
GDT.addPlatform({
    ...
    events : [{
            ...
            getNotification : function (company) {
                return new Notification({
                    header : "Industry News".localize(),
                    text : "Today vNidia announced a new device in their Armour line of products named the vNidia Armour TV. {n} This product is a Cyborg powered TV-based digital media player which came in two models: Armour and Armour Pro, the differences being 16GB flash memory or 500GB HDD. {n} This device uses vNidia's Pegra T1 SoC and runs on Cyborg TV.".localize().format(General.getETADescription('25/7/3', '25/7/4')),
                    image : Placeholder_Icon,
					buttonText : ["Next", "Next", "OK"],
                });
            }
