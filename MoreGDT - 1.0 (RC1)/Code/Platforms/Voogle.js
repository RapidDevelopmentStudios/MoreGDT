...
GDT.addPlatform({
	...
	events : [{
            ...
            getNotification : function (company) {
                return new Notification({
                    header : "Industry News".localize(),
                    text : "Today Voogle announced a completely new device replacing the Nexis products, the Voogle Pikzel {0}. {n} This device features a new design both in hardware and software, alongside the all new design it features a top of the line Crackdragon 821 SoC with an Adremo 530 GPU and 4GB of LPDDR4 RAM. {n} Both devices will ship with Cyborg version 7.1 Nutmeg.".localize().format(General.getETADescription('28/9/1', '28/10/3')),
                    image : Placeholder_Icon,
					buttonText : ["Next", "Next", "OK"],
                });
            }
...
GDT.addPlatform({
    id : 'Platform_Pikzel2',
    name : 'Voogle Pikzel 2',
    company : 'Voogle/HTP',
    startAmount : 4.2,
    unitsSold : 4.8,
    licencePrize : 650000,
    published : '29/10/2',
    platformRetireDate : '30/10/2',
    developmentCosts : 90000,
    genreWeightings : [0.6, 0.6, 0.5, 0.7, 0.4, 0.9],
    audienceWeightings : [0.4, 1, 0.8],
    techLevel : 7,
    iconUri : Placeholder_Icon,
	events : [{
            id : 'Platform_Pikzel2_Announce',
			date : '29/9/3',
            getNotification : function (company) {
                return new Notification({
                    header : "Industry News".localize(),
                    text : "It was announced by Voogle today that the successor to the Pikzel is going to be released {0}, and to no surprise, it will be called the Voogle Pikzel 2. {n} This design builds on the previous model by giving it a new minimum-bezel design, which seems to be standard nowadays, and comes with greatly improved hardware in order to keep up with modern technology. {n} Where some people may not like the design, it will almost definitely be a successful device.".localize().format(General.getETADescription('29/9/3', '29/10/2')),
                    image : Placeholder_Icon,
					buttonText : ["Next", "Next", "OK"],
                });
            }
...
GDT.addPlatform({
    ...
    iconUri : Placeholder_Icon,
	events : [{
            id : 'Platform_Pikzel3_Announce',
			date : '30/9/3',
            getNotification : function (company) {
                return new Notification({
                    header : "Industry News".localize(),
                    text : "A new handheld device by Voogle was announced today, as the successor to the Pikzel 2, the Voogle Pikzel 3. {n} Again this device features another slight redesign of the front side of the device, however this time I can confidently call it an improvement, but on the other hand, the hardware isn't too exciting despite it having the latest technology, and so this isn't a huge improvement over the Pikzel 2. {n} Nonetheless, it is assumed that this device will be successful and will be released {0}".localize().format(General.getETADescription('30/9/3', '29/10/2')),
                    image : Placeholder_Icon,
					buttonText : ["Next", "Next", "OK"],
                });
            }
